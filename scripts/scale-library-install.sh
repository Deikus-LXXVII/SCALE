...
for ignored_path in '.codex/scale-library-src/' '.codex/scale-library' '.codex/scale-telemetry.jsonl' '.agents/skills/scale-*' '.agents/skills/memora-memory-plane' '.opencode/agents/scale-go-*'; do
