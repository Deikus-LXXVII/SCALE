...
expected=(scale-go-explorer.md scale-go-simple-code.md scale-go-routine.md scale-go-code-standard.md scale-go-interface.md scale-go-architecture.md scale-go-prompt-qa.md scale-go-web-designer.md)
