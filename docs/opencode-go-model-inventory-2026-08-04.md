...
| --- | ---: | ---: | --- | --- |
| DeepSeek V4 Flash | $0.14 / $0.28 | 1M | high, max | Default routine, exploration, docs, isolated code. |
| DeepSeek V4 Pro | $0.435 / $0.87 | 1M | high, max | Default standard implementation and specialist code. |
...
| Kimi K2.7 Code | $0.95 / $4.00 | 262K | no exposed variant | Candidate for a future benchmark, not default without explicit reasoning control. |
...
| Qwen3.7 Plus | $0.40 / $1.60 | 1M | high, max | Default frontend and web-design worker. |
...
therefore never chooses Grok, Kimi K3, or Qwen Max automatically. The steady
state is Flash for volume, DeepSeek Pro for ordinary implementation, Luna for
small high-quality review/prompt packets, Qwen Plus for interface work, and
GLM-5.2 only for a narrow high-context decision.
