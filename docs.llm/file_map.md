...
| `skills/cell-orchestrator/` | Reusable multi-agent orchestration workflow and model matrix. |
| `skills/cell-genesis/` | Project initialization workflow. |
...
| `scripts/cell-library-*.sh` | Dynamic library connection, refresh, and role activation. |
